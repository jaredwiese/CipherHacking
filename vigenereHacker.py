...
def main():
    # cipherText = """'Rwexdzggwfi xg, ap bm grxbaqc, cfg dt ljt agui tsurwfciwfi dt stig, sps W xgpf A jpjw ypglgs ihqc wl odfw vxaw vwof ki rwutfngh. W htpqlkhsv ki wf kig kkbddghh xqga ojtb A ypg sv hqzqdz. Ljt paivsj ddmk oprw exdzggg, twi wx K vcl jdzv qu o xgl kgtsg, A whisnam xqjbv qjh ljt ywa. Ivw edbkgfiwprs gh ivau xbygciavn ksu dquchwgppzda eoapuid: vws gycsju dt ljt rwvtqlgs qarwsju hcegiwegh hztpgzgs aw, vwcmiw hzg uomni fwcazq npm ap ivwkg cop hhmrxravn. Hzggs au p yaps cx oplao pagpvgl vws utptl qu rwexdzggsju ..., ivsv tjwtn qarwsj epb tg ssukevwttr. A cb aqutzx kcqdkcsv vd hzkcy ljph vgrwhjtfapv wk cc oxhpwj qu haot, wfitbmkim, sps dsvxsfet; off ivsv ksja uso exdzggg stt kgtiv ljt hjqjpdg dt mpgongazapv hzgb.' -Qzcgzwu Qotdpuw"""
...
def getMostCommonFactors(seqFactors):
    ...
    # Second, put the factor and its count into a tuple,
    # and make a list of these tuples so we can sort them.
    factorsByCount = []
...
def kasiskiExamination(cipherText):
    ...
    # in allLikelyKeyLengths so that they are easier to use later.
    allLikelyKeyLengths = []
